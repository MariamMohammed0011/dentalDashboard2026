...
const EditAdModal = ({ isOpen, onClose, ad, onUpdateAd, isSubmitting }) => {
  ...
  // Pre-fill form values when advertisement data is loaded
  useEffect(() => {
    if (ad && isOpen) {
      setForm({
        title: ad.title || '',
  ...
  // Render preview image source properly based on type
          ...
          >
            ...
            <div className="bg-[#E8F1FF] p-5 sm:p-6 text-right flex items-center justify-between border-b border-[#D2E4FF]/50 flex-shrink-0">
              <div className="flex items-center gap-3 text-[#367AFF]">
                ...
                <h3 className="text-lg font-black">تعديل معلومات الإعلان</h3>
              </div>
              <button 
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-grow overflow-hidden">
              ...
              <div className="p-5 sm:p-7 flex flex-col gap-4 text-right overflow-y-auto flex-grow custom-scrollbar">
                ...
                {/* Target Audience & Expiry side-by-side */}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-600 font-bold text-xs sm:text-sm mr-1">صورة الإعلان</label>
