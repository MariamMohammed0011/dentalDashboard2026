        ...
        {isLoading ? (
          ...
          subs.map((sub) => {
            ...
            return (
              <div
                key={labId || sub.id}
                className="flex items-center w-full bg- dark:bg-slate-900 border border-slate-100 dark:border-slate-800/70 rounded-2xl p-4 shadow-sm hover:shadow-md hover:border-emerald-500/30 transition-all duration-200"
              >
