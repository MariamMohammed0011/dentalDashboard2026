...
const OrderDetailsModal = ({ isOpen, onClose, order }) => {
  ...
  const formatDate = (dateString) => {
    ...
    try {
      ...
      return date.toLocaleDateString('e', {
        year: 'numeric',
        month: 'long',
        day: 'numeric',
        hour: '2-digit',
