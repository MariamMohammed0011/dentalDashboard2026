...
const MembershipCard = ({ request, onUpdateStatus, onShowDetails }) => {
  ...
  return (
    <div dir="rtl" className=" card group relative w-full h-[220px] bg-\ rounded-[2.5rem] border border-slate-100 p-3 transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.12)] hover:-translate-y-2 overflow-hidden flex flex-col">
