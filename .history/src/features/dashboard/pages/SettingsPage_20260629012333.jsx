...
const SettingsPage = () => {
  // جلب بيانات البروفايل الحقيقية من السيرفر كقيم أولية
  const { data: userProfile, refetch: refetchProfile } = useProfile();
  
  // حالة الإعدادات العامة للمنصة
  ...
  // تحديث البروفايل عند تحميل البيانات من الـ Hook
  useEffect(() => {
    if (userProfile) {
      setProfileForm({
  ...
  // رفع وحفظ صورة البروفايل (بشكل محاكي باستخدام Base64)
  ...
  // حفظ بيانات البروفايل الشخصي وتعديل كلمة المرور
  ...
  return (
    <div className="flex flex-col gap-6 px-4 sm:px-10 lg:px-12 pb-10 min-h-full" dir="rtl">
      ...
      {/* المحتوى الرئيسي: التبويبات وقسم الإدخال */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
        ...
        {/* مساحة النماذج والمحتوى المتغير */}
            ...
            >
              ...
              {activeTab === 'orders' && (
                <form onSubmit={handleSaveSettings} className="space-y-6">
                  ...
                  {/* إعدادات المنصة الافتراضية والتوصيل */}
                  <div>
              ...
              {/* تبويب التسويق والإعلانات والمدونات */}
              {activeTab === 'marketing' && (
                <form onSubmit={handleSaveSettings} className="space-y-6">
                  <div className="flex items-center justify-between border-b border-border-main/50 pb-3 mb-4">
