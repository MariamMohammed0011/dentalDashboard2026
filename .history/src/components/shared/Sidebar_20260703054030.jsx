...
export default function Sidebar({ isCollapsed, setIsCollapsed }) {
  ...
  return (
    <aside 
      className={`h-screen  min-h-full flex-col py-4 bg-bg-main z-20 transition-all duration-300 relative border-l border-border-main hidden lg:flex flex-shrink-0 ${
