...
import { FlaskConical, ChevronLeft, Star } from 'lucide-react';
...
const LabCard = ({ id, name, onShowDetails }) => {
  // Fetch detailed profile of the lab to retrieve its average rating
      ...
      <div className="relative z-10 flex flex-col justify-between h-full flex-grow">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          {!isLoading && details?.owner?.status && (() => {
            ...
            return (
              <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-black border shrink-0 ${statusCfg.color}`}>
