...
import { X, User, Mail, Phone, MapPin, Building2, Globe, FileText, Calendar, ShieldCheck } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

const MembershipDetailsModal = ({ request, isOpen, onClose }) => {
          ...
          >
            ...
            <div className="relative h-40 bg-gradient-to-br from-[#367AFF] via-[#367AFF] to-[#0051FF] p-10 flex items-end justify-between overflow-hidden">
              ...
              <div className="relative z-10 flex items-center gap-6">
                ...
                >
                  <h2 className="text-3xl font-black tracking-tight leading-none mb-2">{request.name}</h2>
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 backdrop-blur-md rounded-full border border-white/20">
                    ...
                    <p className="text-white text-xs font-bold uppercase tracking-widest">
                      {request.type === 'doctor' ? 'طبيب أسنان' : 'مخبر تعويضات'}
                    </p>
                  </div>
                </motion.div>
              </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 group cursor-default">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[15px] text-text-main font-bold">{request.phone || 'غير متوفر'}</span>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 group cursor-default">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[15px] text-text-main font-bold">{request.namePlace || 'غير متوفر'}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 group cursor-default">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[15px] text-text-main font-bold truncate max-w-[200px]">{request.addressPlace || 'غير متوفر'}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 group cursor-default">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[15px] text-text-main font-bold">
                        {request.cityPlace} {request.countryPlace ? `/ ${request.countryPlace}` : ''}
                      </span>
                    </div>
                  </div>
                </motion.section>
