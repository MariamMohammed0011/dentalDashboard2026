      ...
      <div className="relative z-10 flex flex-col justify-between h-full w-full">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 min-w-0">
            <div className={`w-14 h-14 bg-gradient-to-br ${isActive
          ...
          <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black border shrink-0 ${isActive
            ...
            <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${isActive ? 'bg-emerald-500 animate-pulse' : 'bg-rose-500'
              }`} />
          ...
          <div className="flex items-center gap-3">
            ...
            <span className={`inline-flex items-center gap-1 px-3 py-1 text-xs font-bold rounded-xl border ${remainingColor}`}>
              {isActive ? (
                ...
                t('subscription.subscriptionCard.expiredValidityLabel')
              )}
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end border-t border-slate-50 dark:border-slate-800/40 pt-4 mt-auto">
          {isActive ? (
            ...
            >
              <CreditCard size={14} />
              {t('subscription.activateAndRenewButton')}
