                ...
                {loadingLabs ? (
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`w-full px-4 py-3.5 rounded-2xl border transition-all flex items-center justify-between text-right cursor-pointer ${selectedLab
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        {selectedLab ? (
                          <div className="flex flex-col min-w-0 text-right">
                            <span className="text-sm font-black truncate">{selectedLab.owner?.namePlace || selectedLab.name || t('subscription.subscriptionModal.labFallbackName', { id: selectedLab.id })}</span>
                            <span className="text-[11px] text-emerald-700 dark:text-emerald-400 font-bold">
                              {t('subscription.subscriptionModal.idLabel')} #{selectedLab.id} {selectedLab.owner?.name ? `• ${selectedLab.owner.name}` : ""}
                            </span>
                          </div>
                        ) : (
                              ...
                              filteredLabs.map((l) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`flex items-center justify-between p-2.5 rounded-xl text-right transition-all duration-200 cursor-pointer ${isSelected
                                  ...
                                  >
                                    <div className="flex items-center gap-2.5 min-w-0">
                                      ...
                                      <div className="flex flex-col text-right min-w-0">
                                        <span className="text-xs sm:text-sm font-black truncate">{l.owner?.namePlace || l.name || t('subscription.subscriptionModal.labFallbackName', { id: l.id })}</span>
