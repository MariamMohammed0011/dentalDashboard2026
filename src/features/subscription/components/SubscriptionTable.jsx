  ...
  return (
    <div className="w-full flex flex-col gap-3" dir="rtl">
      ...
      <div className="hidden lg:flex items-center w-full px-6 py-2 text-slate-400 dark:text-slate-500 font-extrabold text-[12px] uppercase select-none">
        <div className="w-[25%] text-right">{t('subscription.labName')}</div>
        <div className="w-[20%] text-right">{t('subscription.email')}</div>
        <div className="w-[25%] text-right">{t('reports.duration')}</div>
        <div className="w-[12%] text-right">{t('common.status')}</div>
        <div className="w-[8%] text-center">{t('common.status')}</div>
        <div className="w-[10%] text-left">{t('common.actions')}</div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="w-[12%] flex items-center gap-2 min-w-0">
                  <Hourglass size={15} className={isActive ? 'text-amber-500 dark:text-amber-400 shrink-0' : 'text-rose-500 shrink-0'} />
