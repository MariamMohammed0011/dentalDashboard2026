...
import {
  Plus, CreditCard, Search, CheckCircle2, RefreshCw,
  ...
  return (
    <div className="p-2 sm:p-6 lg:p-4 space-y-6" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 p-3 ">
        ...
        <div className="grid grid-cols-2 sm:flex items-center gap-1 sm:gap-2 bg-slate-100 dark:bg-slate-800/80 p-1 sm:p-1.5 rounded-xl sm:rounded-2xl border border-slate-200/60 dark:border-slate-700/60">
          <button
