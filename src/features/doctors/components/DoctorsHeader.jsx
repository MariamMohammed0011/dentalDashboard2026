...
// داخل مكون DoctorsHeader
// خيارات الفلترة المتاحة مطابقة تماماً لقيم الـ API
// داخل مكون DoctorsHeader
const filters = [
  { id: 'all', label: 'كل الأطباء' },
  { id: 'active', label: 'الأطباء النشطين' },
  { id: 'suspended', label: 'الأطباء المعلقين' }, // جعلناها متوافقة مع الـ API (Suspended -> suspended)
  { id: 'pendingadminapproval', label: 'بانتظار موافقة المسؤول' }, // حُولت لحروف صغيرة بالكامل لتنجح المقارنة
];
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center py-2 px-0 gap-4 w-full" dir="rtl">
      ...
      {/* اليسار: حقل الاختيار التلقائي والمنسدل (Auto Select / Dropdown) */}
  ...
  // 💡 التعديل هنا: إضافة حواف دائرية تناسب الأب (rounded-xl) وتنسيق الألوان عند الـ Hover
